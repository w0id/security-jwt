angular.module('jwtApp')
    .controller('UsersController', function ($http, $scope, AuthService) {
        ...
        $scope.deleteUser = function (appUser) {
            $http.delete('api/v1/users/' + appUser.id).success(function (res) {
        ...
        var editUser = function () {
            $http.put('api/v1/users', $scope.appUser).success(function (res) {
                $scope.appUser = null;
        ...
        var addUser = function () {
            $http.post('api/v1/users', $scope.appUser).success(function (res) {
                $scope.appUser = null;
                $scope.confirmPassword = null;
                $scope.userForm.$setPristine();
