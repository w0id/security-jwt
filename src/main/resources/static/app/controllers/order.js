angular.module('jwtApp')
    .controller('OrderController', function ($http, $scope, AuthService) {
        ...
        var init = function () {
            $http.get('api/v1/order').success(function (res) {
                $scope.customer = res;
        ...
        var loadDeliveryTypes = function () {
            $http.get('api/v1/order/delivery_types')
                .then(function (res) {
        ...
        var loadPickUpPoints = function () {
            $http.get('api/v1/order/pickup_points')
                .then(function (res) {
        ...
        $scope.sendOrder = function () {
            ...
            $http.post('api/v1/order', $scope.appOrder).success(function (res) {
                $scope.orderForm.$setPristine();
